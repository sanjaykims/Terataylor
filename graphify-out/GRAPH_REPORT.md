...
## Summary
- 420 nodes · 750 edges · 24 communities (18 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc6aa64a`
...
Cohesion: 0.08
Nodes (34): App(), BookReader, GamesPanel, ImageUploadInput, MainTab, V1Tab, VocabularyPanel, GameType (+26 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (33): isKorean(), SentenceScramble(), shuffle(), VocabPuzzle, WordToken, actx(), Alien, ALIEN_COLS (+25 more)
...
Cohesion: 0.11
Nodes (25): ProgressDashboard, BOOK_LABELS, FEATURE_ICONS, FEATURE_LABELS, formatDate(), formatDuration(), formatSessionWhen(), GAME_LABELS (+17 more)

### Community 5 - "Community 5"
Cohesion: 0.14
Nodes (22): ListeningPanelProps, BookScheduleSection(), daysDiff(), fmtDate(), LessonCard(), LessonScheduleWidget(), utcDays(), activeBookIds() (+14 more)
...
- **Why does `BookReader()` connect `Community 0` to `Community 1`, `Community 10`?**
