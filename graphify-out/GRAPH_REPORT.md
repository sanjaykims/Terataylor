...
## Summary
- 411 nodes · 724 edges · 23 communities (17 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e167333`
...
Cohesion: 0.06
Nodes (85): migrateFromLocalStorage(), BookReader(), buildBookChapterToLessonMap(), buildXingFrame(), CHAPTER_HEADING, CHAPTER_NUMBER_WORDS, chapterNumberForms(), cleanChapterText() (+77 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (47): App(), BookReader, ImageUploadInput, MainTab, ProgressDashboard, V1Tab, Icon(), IconName (+39 more)
...
- **Why does `BookReader()` connect `Community 0` to `Community 9`, `Community 1`?**
