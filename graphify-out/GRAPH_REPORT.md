# Graph Report - Terataylor  (2026-09-05)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 429 nodes · 767 edges · 23 communities (15 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a783d337`
...
- `BookReader()` --calls--> `currentLessonNumberFor()`  [EXTRACTED]
  src/components/BookReader.tsx → src/data/syllabus.ts
...
Cohesion: 0.05
Nodes (92): BookReader, migrateFromLocalStorage(), BookReader(), buildBookChapterToLessonMap(), buildXingFrame(), CHAPTER_HEADING, CHAPTER_NUMBER_WORDS, chapterNumberForms() (+84 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (54): GamesPanel, ImageUploadInput, VocabularyPanel, GameType, Props, TABS, BaseProps, compressImage() (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (45): App(), MainTab, ProgressDashboard, V1Tab, Icon(), IconName, PATHS, SOLID (+37 more)
...
## Knowledge Gaps
- **160 isolated node(s):** `InitState`, `MobileRowProps`, `RowProps`, `SentenceRowsProps`, `KnowledgeMapBranch` (+155 more)
...
- **Why does `BookReader()` connect `Community 0` to `Community 9`, `Community 2`, `Community 5`?**
