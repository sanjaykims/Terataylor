...
## Summary
- 420 nodes · 748 edges · 23 communities (17 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ef241d0`
...
Cohesion: 0.06
Nodes (49): GamesPanel, VocabularyPanel, GameType, Props, TABS, isKorean(), Props, SentenceScramble() (+41 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (46): App(), ImageUploadInput, MainTab, ProgressDashboard, V1Tab, Icon(), IconName, PATHS (+38 more)
...
Cohesion: 0.14
Nodes (21): ListeningPanelProps, BookScheduleSection(), daysDiff(), fmtDate(), LessonCard(), LessonScheduleWidget(), utcDays(), BookId (+13 more)
